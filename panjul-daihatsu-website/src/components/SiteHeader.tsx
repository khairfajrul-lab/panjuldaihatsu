    ...
    <header className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-4 px-4 sm:px-6">
        <Link to="/" className="shrink-0 text-lg font-extrabold tracking-tight text-foreground">
          PANJUL <span className="text-primary">DAIHATSU</span>
        </Link>
      ...
      {open && (
        <nav className="border-t border-border bg-background px-4 py-4 md:hidden">
          ...
          <div className="mt-3 flex items-center gap-4 border-t border-border pt-3">
            <a href="#" aria-label="Facebook" className="text-muted-foreground">
              <Facebook className="h-5 w-5" />
            </a>
            <a href="#" aria-label="TikTok" className="text-muted-foreground">
